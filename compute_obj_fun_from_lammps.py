...
def write_pair_potential(c0_, c1_):
...
def dyn_lammps(x1, x2):
    ...
    for line in range(Natoms):
        ...
        idx = np.where(np.abs(exp_cords[:, 0] - atom_id) < 1e-5)[0]
...
if __name__ == "__main__":
    x1, x2 = read_params_file('params.in')
    # f_val = rosenbrock(x1, x2)
    f_val = dyn_lammps(x1, x2)
